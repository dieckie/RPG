...
public class MainRPG {
	public static void main(String[] args) throws ClassNotFoundException {
		...
		int turn = 0;
		int round = 0;
		AttackE[] attacksg = DataEntity.getAttacks(good);
		...
		while (hpg > 0 && hpb > 0) {
			...
			case 0:
				...
				case 1:
					...
					System.out.println(Attackg.name());
					attackCompleteg = attackg - (defb / 2);
